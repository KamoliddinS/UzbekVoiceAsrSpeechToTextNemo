...
def train_and_evaluate(train_json_path, test_json_path, model_name, num_epochs, model_save_path, checkpoint):
    ...
    if model_name:
        ...
        asr_model = nemo_asr.models.EncDecCTCModel.restore_from(restore_path=model_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default='saved_model/quartznet15x5.pt', help="Name of the pre-trained model for transfer learning. If not provided, train from scratch.")
